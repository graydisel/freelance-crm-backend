...
export class AddProjectsAndTasks1781371955785 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "projects" ADD CONSTRAINT "FK_ca29f959102228649e714827478" FOREIGN KEY ("client_id") REFERENCES "client-profiles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "projects" ADD "budget" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "projects" ADD "client_name" character varying NOT NULL`);
    }
