...
export class SeparateUserProfile1787759525941 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user_profiles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "first_name" character varying(100) NOT NULL, "last_name" character varying(100) NOT NULL, "user_id" uuid, CONSTRAINT "REL_6ca9503d77ae39b4b5a6cc3ba8" UNIQUE ("user_id"), CONSTRAINT "PK_1ec6662219f4605723f1e41b6cb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`INSERT INTO "user_profiles" ("first_name", "last_name", "user_id") SELECT "first_name", "last_name", "id" FROM "users"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "first_name"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "last_name"`);
        await queryRunner.query(`ALTER TYPE "public"."projects_status_enum" ADD VALUE 'archived'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."projects_status_enum_old" AS ENUM('planning', 'active', 'review', 'completed', 'paused')`);
        ...
        await queryRunner.query(`UPDATE "users" SET "first_name" = p."first_name", "last_name" = p."last_name" FROM "user_profiles" p WHERE p."user_id" = "users"."id"`);
